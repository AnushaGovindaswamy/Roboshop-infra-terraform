module "vpc" {
  source = "git::https://github.com/AnushaGovindaswamy/tf-module-vpc.git"
...
module "docdb" {
  source = "git::https://github.com/AnushaGovindaswamy/tf-module-docdb.git"
...
module "rds" {
  source = "git::https://github.com/AnushaGovindaswamy/tf-module-rds.git"
...
module "elasticache" {
  source = "git::https://github.com/AnushaGovindaswamy/tf-module-elasticache.git"
...
module "rabbitmq" {
  source = "git::https://github.com/AnushaGovindaswamy/tf-module-amazon-mq.git"
...
module "alb" {
  source = "git::https://github.com/AnushaGovindaswamy/tf-module-alb.git"
...
module "app" {
  ...
  source     = "git::https://github.com/AnushaGovindaswamy/tf-module-app.git"
